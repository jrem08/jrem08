...
Entusiasta del **desarrollo web y análisis de datos**, con un fuerte interés en la experiencia visual del usuario como el **diseño web, digital y publicitario**, combinando creatividad con funcionalidad para ofrecer productos atractivos e intuitivos.
